        ...
        <ul className="messages__block" id="messagesBlock">
          <li className="messages__sent">
            ...
            <div className="message__desc">
              <p className="message">
                Lorem ipsum cere laboriosam quo veritatis? Cumque, earum,
                eligendi error facere , consecrated
              </p>
          ...
          <li className="messages__sent reverse">
            ...
            <div className="message__desc">
              <p className="message">
                Lorem ipsum dolor sit amet, lorem consecrated
              </p>
          ...
          <li className="messages__sent reverse">
            ...
            <div className="message__desc">
              <p className="message">
                Lorem ipsum dolor sit amet, consectetur adipisicing error est
                eum, explicabo odio qui quidemelit. Alias aliquid aperiam
                deserunt eaque enim
              </p>
