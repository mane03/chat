...
const Conversation = () => {
  ...
  return(
      <>
        <div className="conversations conv-active chats">
          <div onClick={() => toggle()} className="project__desc project__close">
            <h2 className="project__title">Conversations</h2>
            <svg className={isOpen ? "arrow" : "active"} width="21" height="21" viewBox="0 0 21 21" fill="none"
          ...
          <div className={isOpen ? "group__items" : "active"}>
            <div className="conversation__block user">
              ...
              <h3 className="user__name">Joe Lastname</h3>
            </div>
            <div className="conversation__block user">
              <div className="user__image" />
              <h3 className="user__name">Ann Lastname</h3>
            </div>
            <div className="conversation__block user">
              <div className="user__image" />
              <h3 className="user__name">Leo Lastname</h3>
            </div>
          </div>
        </div>
      </>
